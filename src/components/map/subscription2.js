  ...
  return (
    <Card>
      <CardContent sx={{ pb: '8px' }}>
        ...
        {/*  <InfoIcon />*/}
        {/*</Tooltip>*/}
        <Typography variant="subtitle2" sx={{color: "#212636", mb: 1}}>S<sub>терр</sub> ≈ 10.3 тыс. га.</Typography>

        <Typography variant="subtitle2" sx={{color: "#212636", mb: 1}}>Состояние культур</Typography>
        <Box
          sx={{
            display: "flex",
